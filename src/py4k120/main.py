...
from py4k120 import DisplaySettings, Py4K120
...
def main() -> None:
    ...
    py4k120 = Py4K120(display, args.timeout, args.set_delay, args.retry_delay, args.max_retries)

    if args.background and py4k120.already_running:
        py4k120.show_message_box("An instance of this script is already running.", "4K120")
        sys.exit(0)

    if args.background:
        py4k120.run_background()
